...
object ColumnDefinitionFlags:
  ...
  def hasBitFlag(bitset: Seq[ColumnDefinitionFlags], flag: ColumnDefinitionFlags): Boolean = (toBitset(bitset) & flag.code) == flag.code
  ...
  def setBitFlag(bitset: Seq[ColumnDefinitionFlags], flag: ColumnDefinitionFlags): Seq[ColumnDefinitionFlags] = apply(toBitset(bitset) | flag.code)

  def setBitFlag(bitset: Seq[ColumnDefinitionFlags], code: Long): Seq[ColumnDefinitionFlags] = apply(toBitset(bitset) | code)
